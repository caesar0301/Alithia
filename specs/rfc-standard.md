# Alithia RFC Specifications & Management Guide

This document defines the process, conventions, and guidelines for creating and managing RFCs (Requests for Comments) in the Alithia project.
...
RFCs are the authoritative specifications for the Alithia system. They define:
...
Alithia RFCs fall into three kinds, each with a distinct purpose and level of abstraction:
...
**For questions about RFC management, contact the Alithia core team.**
...
- Uses SOOTHE_HOME=~/.alithia/soothe/ (set in ``alithia.__init__``)
...
from alithia.config import load_config as load_alithia_config
from alithia.soothe_defaults import apply_soothe_home_defaults
...
def build_agent(
    ...
    *,
    ...
    from alithia.plugin_registration import register_alithia_plugins
...
class AlithiaAgent:
    ...
    async def run_paperscout(
        ...
        *,
        ...
        from alithia.paperscout.runner import run_paperscout_for_dates

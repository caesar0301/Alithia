# IG-010-omni-research-subagent: OmniResearch Subagent Implementation

**RFC Source**: [RFC-010-omni-research-subagent](../specs/RFC-010-omni-research-subagent.md)
**Target Module**: `alithia_agent/omr`
...
This guide implements the OmniResearch (omr) soothe subagent as defined in RFC-010. The implementation follows the existing patterns from paperscout/paperlens subagents and adds pattern-based research workflow orchestration.
...
class OmrAgentConfig(BaseModel):
    ...
    RFC Reference: RFC-010 Section 8.1
    """
...
class OmrRuntimeConfig(BaseModel):
    ...
    RFC Reference: RFC-010 Section 8.2
    """
    ...
    def build_runtime_config(
        ...
        RFC Reference: RFC-010 Section 2.3
        """
...
class AgentState(TypedDict):
    ...
    RFC Reference: RFC-010 Section 7.1
    """
...
class InputRouter:
    ...
    RFC Reference: RFC-010 Section 10.3
    """
...
3. Create `alithia_agent/omr/` package structure
...
This implementation guide provides the concrete design for the OmniResearch subagent following RFC-010 specifications. Key implementation points:
